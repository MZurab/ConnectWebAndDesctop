 ...
 * @license require2JS 2.3.3 Copyright jQuery Foundation and other contributors.
 * Released under MIT license, https://github.com/require2js/require2js/blob/master/LICENSE
 */
var require2js, require2, define;
! function(global, setTimeout) {
    ...
    function makeError(e, t, i, r) {
        var n = new Error(t + "\nhttp://require2js.org/docs/errors.html#" + e);
        return n.require2Type = e, n.require2Modules = r, i && (n.originalError = i), n
    }
    ...
    function newContext(e) {
        ...
        function r(e) {
            isBrowser && each(scripts(), function(t) {
                if (t.getAttribute("data-require2module") === e && t.getAttribute("data-require2context") === q.contextName) return t.parentNode.removeChild(t), !0
            })
        }

        function n(e) {
            var t = getOwn(y.paths, e);
            if (t && isArray(t) && t.length > 1) return t.shift(), q.require2.undef(e), q.makerequire2(null, {
                skipMap: !0
            })([e]), !0
        }
        ...
        function g(e) {
            ...
            return m(t, q.onScriptLoad, "load", "onreadystatechange"), m(t, q.onScriptError, "error"), {
                node: t,
                id: t && t.getAttribute("data-require2module")
            }
        }
        ...
        return E = {
            require2: function(e) {
                return e.require2 ? e.require2 : e.require2 = q.makerequire2(e.map)
            },
            exports: function(e) {
            ...
            fetch: function() {
                if (!this.fetched) {
                    ...
                    var e = this.map;
                    return this.shim ? void q.makerequire2(this.map, {
                        ...
                        if (this.error) this.emit("error", this.error);
                            ...
                            if (this.defining = !0, this.depCount < 1 && !this.defined) {
                                if (isFunction(o)) {
                                    ...
                                    if (this.map.isDefine && void 0 === n && (t = this.module, t ? n = t.exports : this.usingExports && (n = this.exports)), e) return e.require2Map = this.map, e.require2Modules = this.map.isDefine ? [this.map.id] : null, e.require2Type = this.map.isDefine ? "define" : "require2", c(this.error = e)
                                } else n = o;
            ...
            callPlugin: function() {
                ...
                this.depMaps.push(r), u(r, "defined", bind(this, function(r) {
                    ...
                    return this.map.unnormalized ? (r.normalize && (l = r.normalize(l, function(e) {
                        ...
                        this.inited = !0, this.error = e, e.require2Modules = [t], eachProp(S, function(e) {
            ...
            configure: function(e) {
                ...
                }), (e.deps || e.callback) && q.require2(e.deps || [], e.callback)
            },
            ...
            makerequire2: function(t, n) {
                function o(i, r, u) {
                    var d, p, f;
                    return n.enableBuildCallback && r && isFunction(r) && (r.__require2JsBuild = !0), "string" == typeof i ? isFunction(r) ? c(makeError("require2args", "Invalid require2 call"), u) : t && hasProp(E, i) ? E[i](S[t.id]) : req.get ? req.get(q, i, t, o) : (p = a(i, t, !1, !0), d = p.id, hasProp(j, d) ? j[d] : c(makeError("notloaded", 'Module name "' + d + '" has not been loaded yet for context: ' + e + (t ? "" : ". Use require2([])")))) : (v(), q.nextTick(function() {
    ...
    var req, s, head, baseElement, dataMain, src, interactiveScript, currentlyAddingScript, mainScript, subPath, version = "2.3.3",
        ...
        cjsrequire2RegExp = /[^.]\s*require2\s*\(\s*["']([^'"\s]+)["']\s*\)/g,
        jsSuffixRegExp = /\.js$/,
        currDirRegExp = /^\.\//,
        op = Object.prototype,
        ostring = op.toString,
    ...
    if ("undefined" == typeof define) {
        if ("undefined" != typeof require2js) {
            if (isFunction(require2js)) return;
            cfg = require2js, require2js = void 0
        }
        "undefined" == typeof require2 || isFunction(require2) || (cfg = require2, require2 = void 0), req = require2js = function(e, t, i, r) {
            var n, o, a = defContextName;
            return isArray(e) || "string" == typeof e || (o = e, isArray(t) ? (e = t, t = i, i = r) : e = []), o && o.context && (a = o.context), n = getOwn(contexts, a), n || (n = contexts[a] = req.s.newContext(a)), o && n.configure(o), n.require2(e, t, i)
            ...
            e()
        }, require2 || (require2 = req), req.version = version, req.jsExtRegExp = /^\/|:|\?|\.js$/, req.isBrowser = isBrowser, s = req.s = {
            contexts: contexts,
            newContext: newContext
        }, req({}), each(["toUrl", "undef", "defined", "specified"], function(e) {
            req[e] = function() {
                var t = contexts[defContextName];
                return t.require2[e].apply(t, arguments)
            }
            ...
            var r, n = e && e.config || {};
            if (isBrowser) return r = req.createNode(n, t, i), r.setAttribute("data-require2context", e.contextName), r.setAttribute("data-require2module", t), !r.attachEvent || r.attachEvent.toString && r.attachEvent.toString().indexOf("[native code") < 0 || isOpera ? (r.addEventListener("load", e.onScriptLoad, !1), r.addEventListener("error", e.onScriptError, !1)) : (useInteractive = !0, r.attachEvent("onreadystatechange", e.onScriptLoad)), r.src = i, n.onNodeCreated && n.onNodeCreated(r, n, t, i), currentlyAddingScript = r, baseElement ? head.insertBefore(r, baseElement) : head.appendChild(r), currentlyAddingScript = null, r;
            if (isWebWorker) try {
            ...
            var r, n;
            "string" != typeof e && (i = t, t = e, e = null), isArray(t) || (i = t, t = null), !t && isFunction(i) && (t = [], i.length && (i.toString().replace(commentRegExp, commentReplace).replace(cjsrequire2RegExp, function(e, i) {
                t.push(i)
            }), t = (1 === i.length ? ["require2"] : ["require2", "exports", "module"]).concat(t))), useInteractive && (r = currentlyAddingScript || getInteractiveScript(), r && (e || (e = r.getAttribute("data-require2module")), n = contexts[r.getAttribute("data-require2context")])), n ? (n.defQueue.push([e, t, i]), n.defQueueMap[e] = !0) : globalDefQueue.push([e, t, i])
        }, define.amd = {
            jQuery: !0
